...
| | shipped today |
|---|---|
| **gatherers** | role **9** rugged travellers fetch alchemist ingredients from scree/meadow picking grounds, camping where dusk finds them, shunning the deep mountains (`OVERLAND.md` §13c) |
