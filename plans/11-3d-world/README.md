...
**ACTIVE — P0, P1, P2, P2b done; P3 next.** The kernel now stands on the field: `sim.loft`
...
| **P3** — the 3D view: camera + world | MH | projection round-trip test; user visual in `make play` | **NEXT** |
